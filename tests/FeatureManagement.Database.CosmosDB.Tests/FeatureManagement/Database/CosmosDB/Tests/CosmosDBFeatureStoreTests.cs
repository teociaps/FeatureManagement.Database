...
public class CosmosDBFeatureStoreTests : IClassFixture<IntegrationTestWebAppFactory>, IDisposable
{
    private readonly IServiceScope _scope;
    private readonly IFeatureStore _featureStore;

    public CosmosDBFeatureStoreTests(IntegrationTestWebAppFactory factory)
    {
