...
public class NHibernateFeatureStoreTests : IClassFixture<IntegrationTestWebAppFactory>, IDisposable
{
    private readonly IServiceScope _scope;
    private readonly IFeatureStore _featureStore;

    public NHibernateFeatureStoreTests(IntegrationTestWebAppFactory factory)
    {
